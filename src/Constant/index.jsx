import { getStaff } from "./LoginConstant";
...
export const maxUploadFileSize=2048; //Value IN KB
export const maxNoFileCount=10;
export const maxFileUpload=3;

// Itohen-DMS
var Server;
//export const apiUrlPath='http://192.168.1.108:8010/api';
  // export const apiUrlPath='http://192.168.1.24:8011/api';
//export const apiUrlPath='http://34.208.216.116:8080/api';

export const apiUrlPath='http://192.168.1.115:8010/api';


/*UAT Server*/
//export const apiUrlPath='http://34.208.216.116:8083/api';

/*Live Server */
//export const apiUrlPath='https://dms.itohen.pro:8080/api';

getStaff === "Staff" ?  Server = apiUrlPath+'/staff' :  Server = apiUrlPath;
//export const ServerUrl = 'http://34.208.216.116:8080/api'
//export const ServerUrl = 'http://192.168.1.23:8000/api'
//  export const ServerUrl = 'http://192.168.1.24:8011/api'
export const ServerUrl = Server;

export const GeneralSettingsLabel = 'General Settings';
export const NotificationSettingsLabel = 'Notification Settings';
export const EmailScheduleSettingsLabel = 'Email Schedule Settings';
