...
import {
  ...
  ModalBody,
  ModalFooter,
  ModalHeader, Label, FormGroup, Button
} from 'reactstrap';
          ...
          if(result.isConfirmed){
            ...
            .then((response) => {
              // response.data = apidecrypt(response.data)
               //console.log("Factory",response.data.data.length);
  ...
  return (
    <Modal isOpen={modal} toggle={toggle}  backdrop="static" centered id="addsatffmodal">
      ...
      <ModalBody>
        ...
        <FormGroup>
          <Label> Factory</Label><sup className="font-danger">*</sup>
          <Input
        ...
        <FormGroup>
          <Label> Contact Person</Label><sup className="font-danger">*</sup>
          <Input 
        ...
        <FormGroup>
          <Label> Contact Number</Label><sup className="font-danger">*</sup>
          <Input 
        ...
        <FormGroup>
          <Label>Address</Label><sup className="font-danger">*</sup>
          <Input 
        ...
        <FormGroup>
          <Label>City</Label><sup className="font-danger">*</sup>
          <Input 
