                                ...
                                <UL>
                                    <LI>
                                        <div className="droplet-dropdown bookmark-dropdown flip-back-content">
                                            ...
                                            <ListOfMenu removeFix={removeFix} bookmarkItems={bookmarkItems} 
                                                setCallbackBookmark={setCallbackBookmark} searchValue={searchValue} 
                                                setBookmarkItems={setBookmarkItems} searchResult={searchResult} 
